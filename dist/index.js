...
(function (ANNOTATION_LEVEL) {
    ANNOTATION_LEVEL["NOTICE"] = "notice";
    ANNOTATION_LEVEL["WARN"] = "warn";
    ANNOTATION_LEVEL["ERROR"] = "error";
})(ANNOTATION_LEVEL || (ANNOTATION_LEVEL = {}));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const level = core.getInput('level').toLowerCase() ||
